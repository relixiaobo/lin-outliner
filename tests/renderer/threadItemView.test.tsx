...
describe('ThreadItemView user message presentation', () => {
  ...
  test('strips a host-authored user-role Item to prose, and keeps it copyable but not editable', async () => {
    const item: UserMessageThreadItem = {
    ...
    // Position is identity: someone else's words leave the reader's own slot
    // and its bubble, becoming plain prose that the speaker header above names.
    // Carrying a second attribution here would say the same thing twice.
    ...
    expect(message?.querySelector('.thread-host-event-label')).toBeNull();
