// The SHIPPED context-menu path, kept in the tree as the ORACLE while the
// registry view is proven against it. `tests/renderer/contextMenuParity.test.tsx`
// renders both over a corpus of document states and admits only the three
// approved deltas; this file is deleted in the PR's final stage, and the
// golden fixtures it generated remain as the permanent guard.
...
interface LegacyNodeContextMenuProps {
  x: number;
  y: number;
  node: NodeProjection;
  targetId: NodeId;
...
export function LegacyNodeContextMenu(props: LegacyNodeContextMenuProps) {
  const t = useT();
