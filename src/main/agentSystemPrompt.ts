...
const L0_FIRMWARE_BLOCKS = [
  ...
  },
  {
    ...
    lines: [
      ...
      `- If installing or enabling the dependency is impossible because a required capability, network, payment flow, or project constraint is unavailable, explain the concrete blocker. Ask only when a real fallback choice cannot be inferred.`,
