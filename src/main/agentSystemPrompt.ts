...
const L0_FIRMWARE_BLOCKS = [
  ...
  },
  {
    ...
    lines: [
      ...
      `- For images generated by generate_image, place each returned markdownImage exactly where the image belongs in the final answer instead of rewriting it as a Markdown image path.`,
