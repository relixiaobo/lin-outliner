...
const ISSUE_RELATION_SCHEMA = {
  ...
  properties: {
    type: {
      ...
      description: 'Relationship kind between the current Issue and another independently managed Issue.',
    },
...
const RECURRING_TEMPLATE_SCHEMA = {
  ...
  properties: {
    delegate: AGENT_REF_SCHEMA,
    relations: { type: 'array', items: ISSUE_RELATION_SCHEMA, description: 'Independent-Issue relations copied to generated Issues.' },
    trigger: ISSUE_TRIGGER_SCHEMA,
