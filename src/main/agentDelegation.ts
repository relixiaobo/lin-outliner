...
function buildRunDirective(params: AgentToolParams): string {
  ...
  return [
    ...
    '3. Report child Issue or sub-run outcomes only to the direct parent controller; each parent summarizes upward in turn.',
    '4. Verify sub-run results before accepting them as done; create replacement work for rejected results when budget remains.',
