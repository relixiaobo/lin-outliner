...
export const AGENT_ISSUE_TOOL_DEFINITIONS: readonly TenonAgentToolDefinition[] = ([
  ...
  },
  {
    ...
    promptGuidanceText: 'Use for explicit retries, continuations, verification attempts, or direct requests to start an existing eligible Issue. Do not call immediately after issue_create for a when-ready unattended Issue; runtime starts that Issue when eligible.',
