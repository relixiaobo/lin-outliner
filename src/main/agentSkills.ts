...
const DEFAULT_BUILT_IN_SKILLS: readonly BuiltInSkillInput[] = [{
  ...
  body: [
    ...
    '   - Store personal agents at `~/.agents/agents/<agent-name>/AGENT.md` and repo/workspace agents at `<workspace>/.agents/agents/<agent-name>/AGENT.md`.',
    ...
    '   - Optional fields: `tools`, `disallowed-tools`, `skills`, `model`, `effort`, `max-turns`, and `background`.',
    ...
    '   - The file-tool gateway validates the AGENT.md, rejects support files/deletes/trusted permission mode, and hot-reloads the agent registry.',
