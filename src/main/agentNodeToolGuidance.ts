...
export const SEARCH_OPERATOR_REFERENCE = [
  ...
  '- User fields: FIELD_IS, FIELD_IS_NOT, FIELD_CONTAINS, LT, GT, IS_EMPTY, IS_NOT_EMPTY, HAS_FIELD, FIELD_IS_SET, FIELD_IS_NOT_SET, FIELD_IS_DEFINED, FIELD_IS_NOT_DEFINED. These use field:: [[Field^node:...]] except HAS_FIELD may omit field:: to match any field.',
  '- Date fields: DATE_OVERLAPS uses field:: [[Date field^node:...]] plus value:: YYYY-MM-DD or start/end. OVERDUE checks unfinished nodes with overdue date field values and may include field:: to limit which date field.',
