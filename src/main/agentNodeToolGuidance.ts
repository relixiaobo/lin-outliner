...
export const LIN_OUTLINE_CREATE_GUIDANCE = [
  ...
  'It supports "Title - description", #tags, #中文 tags, [[#tag]] / #[[multi word tags]], Field:: value, references, nested children, search nodes, and [ ]/[x] checkbox state when the marker is alone or whitespace-separated from the title.',
