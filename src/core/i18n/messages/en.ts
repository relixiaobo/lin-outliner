...
export const en = {
  ...
  "fields": {
    ...
    skills: {
      ...
      curationReport: 'Review Skills',
      curationRunning: 'Reviewing…',
      curationTitle: 'Skill curation report',
      curationSummary: ({ included, excluded, findings }: { included: number; excluded: number; findings: number }) =>
        `${included} included, ${excluded} excluded, ${findings} finding${findings === 1 ? '' : 's'}`,
      curationIncluded: 'Included',
      curationExcluded: 'Excluded',
      curationNoFindings: 'No deterministic findings.',
      curationUnhashed: 'No content hash',
      curationClose: 'Done',
      sourceLocal: 'local',
