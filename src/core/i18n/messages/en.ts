...
commandPalette: {
  ...
  agent: {
    ...
    turnDetails: {
      ...
      unavailable: 'Turn Details are unavailable.',
      retry: 'Retry',
      overview: 'Overview',
      requestConstruction: 'Request Construction',
      providerCalls: ({ count }: { count: number }) => `Provider Calls (${count})`,
      ...
      stablePrompt: 'Stable system prompt',
      promptBlock: ({ layer, id }: { layer: string; id: string }) => `${layer} · ${id}`,
      toolSchemas: ({ count }: { count: number }) => `Tool schemas (${count})`,
      runtimeSettings: 'Provider runtime',
      ...
      requestParameters: 'Provider request parameters',
      messageWindow: ({ count }: { count: number }) => `Normalized message window (${count})`,
      ...
      requestFingerprint: 'Diagnostic request fingerprint',
      ...
      protectedBoundary: 'Protected message index',
