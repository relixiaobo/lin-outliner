...
export const en = {
  ...
  agent: {
    ...
    trajectory: {
      ...
      selectRecord: 'Select a Trajectory record.',
      turns: 'Turns',
      records: 'Records',
      ...
      exportCopy: 'Export uses the same redacted Trajectory projection and retained diagnostics.',
      copyRecord: 'Copy record evidence',
      ...
      noRetainedOutput: 'No retained output.',
