  ...
  agent: {
    ...
    thread: {
      ...
      activity: {
        ...
        commandInterrupted: ({ command }: { command: string }) => `Command interrupted · ${command}`,
        ...
        fileChangeInterrupted: ({ count }: { count: number }) => `Interrupted changing ${count} ${count === 1 ? 'file' : 'files'}`,
        usingTool: ({ name }: { name: string }) => `Using ${name}`,
        usedTool: ({ name }: { name: string }) => `Used ${name}`,
        toolFailed: ({ name }: { name: string }) => `${name} failed`,
        toolInterrupted: ({ name }: { name: string }) => `${name} interrupted`,
        ...
        searchInterrupted: ({ query }: { query: string }) => `Web search interrupted · ${query}`,
