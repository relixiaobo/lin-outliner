...
export const en = {
  ...
  providerConfig: {
    availableKeyHint: 'A credential is already available. Leave this field empty to keep using it.',
    duplicateId: 'This provider already exists. Choose a different ID.',
    providerIdHint: 'Use a unique name, such as office-proxy.',
    replaceKey: 'Replace Key…',
    connectionHint: 'Connect this provider to use its models in Tenon.',
    authentication: 'Connect using',
    account: 'Account',
    advanced: 'Advanced',
    retry: 'Try Again',
    invalidUrl: 'Enter a complete URL starting with http:// or https://.',
    endpointRequired: 'Enter the API endpoint supplied by your provider or local server.',
    endpointOptional: 'Leave empty to use the provider’s default address. Change only for a proxy or custom server.',
    savedKeyHint: 'A key is saved. Leave this field empty to keep it, or paste a replacement.',
    localKeyHint: 'Optional if your local server does not require authentication.',
    keyHint: 'Use an API key from your provider account.',
    testHint: 'Optional. Tests these details without saving them.',
