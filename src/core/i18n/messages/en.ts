...
export const en = {
  ...
  settings: {
    ...
    security: {
      ...
      boundariesGroup: 'Folder Access',
      boundariesAriaLabel: 'Folder access',
      noBoundaries: 'No additional folders.',
...
commandPalette: {
  ...
  agent: {
    ...
    chat: {
      ...
      deleteChannelTitle: ({ name }: { name: string }) => `Delete "${name}"?`,
      deleteChannelMessage: 'This removes the Channel and its transcript history. This cannot be undone.',
    ...
    toolCall: {
      ...
      generatedWith: ({ provider, model }: { provider: string; model: string }) => `Generated with ${provider} · ${model}`,
      ...
      verbs: {
        ...
        stopTask: { base: 'stop bash task', pending: 'Stopping bash task', done: 'Stopped bash task' },
        ...
        checkHistory: { base: 'check outline undo stack', pending: 'Checking outline undo stack', done: 'Checked outline undo stack' },
    ...
    issue: {
      heading: 'Issues',
      panelAriaLabel: 'Agent work',
      viewsAriaLabel: 'Issue views',
      listAriaLabel: 'Issue list',
      issue: 'Issue',
      ...
      activeSessions: ({ count }: { count: number }) =>
        count === 1 ? '1 Agent Session active' : `${count} Agent Sessions active`,
      notification: {
        complete: 'completed',
        error: 'needs attention',
        canceled: 'canceled',
        open: ({ status, title }: { status: string; title: string }) => `Open Issue details: ${title} (${status})`,
      },
      view: {
        inbox: 'Inbox',
        today: 'Today',
    ...
    issueDetail: {
      detailsAriaLabel: 'Issue details',
      ...
      backToParent: 'Back to parent Issue',
      breadcrumbAriaLabel: 'Issue path',
      instructions: 'Instructions',
      latestResult: 'Latest result',
      noSessionActivity: 'No Agent Session activity yet.',
      nextRun: 'Next run',
      process: 'Process',
      execution: 'Execution',
      sessionNotFound: 'Agent Session was not found.',
      ...
      acceptReview: 'Accept and complete',
      acceptingReview: 'Completing...',
      reviewFailed: 'Could not complete the human review.',
      activityEvent: {
        created: 'Created.',
        updated: 'Updated.',
        updatedFields: ({ fields }: { fields: string }) => `Updated ${fields}.`,
        archived: 'Archived.',
        deleted: 'Deleted.',
        changedField: ({ field }: { field: string }) => `Changed ${field}.`,
        changedStatus: ({ status }: { status: string }) => `Status changed to ${status}.`,
        action: {
          agentSessionStarted: 'Agent Session started.',
          agentSessionStopped: 'Agent Session stopped.',
          childIssueCreated: 'Child Issue created.',
          childIssueCompleted: 'Child Issue completed.',
          skippedNextOccurrence: 'Skipped next occurrence.',
          generatedIssue: 'Generated Issue.',
        },
        verification: {
          pass: ({ body }: { body: string }) => `Passed: ${body}`,
          fail: ({ body }: { body: string }) => `Failed: ${body}`,
          partial: ({ body }: { body: string }) => `Partially passed: ${body}`,
        },
      },
      activityMetadata: {
        time: 'Time',
