...
export const en = {
  ...
  shell: {
    ...
    filePreview: {
      ...
      translationNotConfigured: 'Select an available model or configure one in Settings before translating webpages.',
      translationFailed: "Some visible content couldn't be translated.",
