...
export const en = {
  ...
  settings: {
    ...
    memory: {
      ...
      dreamRunNowSublabel: "Manually consolidate recent chats into today's memory node. Scheduled Dream still runs at most once per day.",
...
commandPalette: {
  ...
  agentDebug: {
    ...
    // Run detail.
    runListAriaLabel: 'Runs',
    selectedRunAriaLabel: 'Selected run details',
    ...
    cachedContextShare: 'Cached share',
    cacheChartLabel: 'Input context cache composition',
    uncachedInput: 'Uncached input',
    cacheRead: 'Cache read',
    cacheWrite: 'Cache write',
    noCacheActivity: 'No cache activity for this run.',
