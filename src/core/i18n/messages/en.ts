...
commandPalette: {
  ...
  agent: {
    ...
    turnDetails: {
      ...
      loading: 'Loading Turn Diagnostics...',
      unavailable: 'Turn Diagnostics are unavailable.',
      retry: 'Retry',
      summary: 'Summary',
      timeline: ({ count }: { count: number }) => `Timeline (${count})`,
      ...
      acceptedInputActivity: 'Accepted Input',
      steeringActivity: 'Steering Input',
      toolExecutionBatch: ({ count }: { count: number }) => `Tool Execution (${count})`,
      consumedByCall: ({ index }: { index: number }) => `Consumed by Call ${index}`,
      ...
      notConsumed: 'Not consumed by a model call',
      ...
      rawProviderPayload: 'Provider payload JSON',
      rawProviderResponse: 'Normalized response JSON',
