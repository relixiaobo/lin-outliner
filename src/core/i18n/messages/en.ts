...
export const en = {
  ...
  settings: {
    ...
    general: {
      ...
      memoryResetSublabel: 'Permanently delete canonical Memory containers. Ordinary notes and stray tagged Nodes are preserved.',
      memoryResetAction: 'Reset Memory',
      memoryResetConfirmTitle: 'Reset Memory',
      memoryResetConfirmMessage: 'Permanently delete all canonical Memory from Daily Notes? Old Thread history will not recreate it.',
