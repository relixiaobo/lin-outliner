...
export const en = {
  ...
  agent: {
    ...
    thread: {
      ...
      inputRemaining: ({ seconds }: { seconds: number }) => `${seconds}s remaining`,
      inputRestoring: 'Restoring the question…',
      inputRestoreError: 'The question could not be restored. Retry or interrupt the turn.',
      inputRetry: 'Retry',
      inputInterrupt: 'Interrupt Turn',
      inputUnsent: 'Unsent answers',
      inputExpired: 'Question expired. No answer was submitted.',
      inputSkippedRecovery: 'Question skipped. Your unsent text is saved here.',
      inputSkipped: 'Skipped. Choose an answer to include it instead.',
      inputSkip: 'Skip question',
      inputWriteAnswer: 'Write an answer',
      inputContinue: 'Continue with answers',
      inputContinueEmpty: 'Continue without answers',
      inputContinueHint: 'Send filled answers and continue; leave the rest unanswered.',
      inputDeadlineHint: 'When time runs out, the agent continues without these unsent answers.',
      inputChat: 'Chat about this',
      inputMore: 'More question actions',
      inputDiscussSend: 'Send and discuss',
      inputDiscussHint: 'Send your message and the active answers to discuss these questions.',
      inputAnswerQuestions: 'Answer questions',
      inputAnsweredCount: ({ count, total }: { count: number; total: number }) => `${count} of ${total} answered`,
      inputUnanswered: 'Unanswered',
      inputSendAnswer: 'Send answer',
      inputSendAnswers: 'Send answers',
      inputSavedDraft: 'Unsent answer draft',
      inputReturnToMessage: 'Back to message',
      inputInMessage: 'In message draft',
      inputShelfCount: ({ count }: { count: number }) => `Unsent answers (${count})`,
      inputCancelled: 'Question cancelled. Your unsent answers are saved here.',
      inputFailed: 'Question failed. Your unsent answers are saved here.',
      inputInvalidated: 'Question ended when the agent restarted. Your unsent answers are saved here.',
      inputUnknown: 'Answer status could not be confirmed. Your draft is saved here.',
      inputReview: 'Review answers',
      inputCopy: 'Copy',
      inputAddToMessage: 'Add to message',
      inputDiscard: 'Discard',
      inputCopyError: 'Could not copy. Select and copy the text above.',
