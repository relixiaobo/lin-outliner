...
commandPalette: {
  ...
  agent: {
    ...
    chat: {
      ...
      channelGoal: 'Goal',
      channelGoalPlaceholder: 'Coordinate the launch plan',
      channelGoalRequired: 'Add a goal for this Channel.',
      channelMembersRequired: 'Choose at least two agents for a Channel.',
      channelSeed: 'Seed note',
      channelSeedPlaceholder: 'Optional first message shared with the room',
