...
commandPalette: {
  ...
  agent: {
    ...
    turnDetails: {
      ...
      retry: 'Retry',
      overview: 'Overview',
      executionTimeline: ({ count }: { count: number }) => `Execution Timeline (${count})`,
      audit: 'Audit',
      ...
      noProviderCalls: 'No Provider Calls were recorded.',
      providerCall: ({ index }: { index: number }) => `Provider Call ${index}`,
      request: 'Request',
      preparedModelContext: 'Prepared model context',
      ...
      noLocalExecution: 'No local execution was recorded for this call.',
      rawProviderRequest: 'Provider payload JSON',
      rawProviderResponse: 'Normalized assistant message',
      ...
      systemReminder: ({ kind }: { kind: string }) => `System reminder · ${kind}`,
      attachment: 'Attachment',
      textPart: 'Text part',
      ...
      value: 'Value',
      noAssistantResponse: 'No assistant response was recorded.',
