...
commandPalette: {
  ...
  agent: {
    ...
    turnDetails: {
      ...
      retry: 'Retry',
      overview: 'Overview',
      requestsAndResults: ({ count }: { count: number }) => `Requests & Results (${count})`,
      ...
      modelRequest: ({ index }: { index: number }) => `Request ${index}`,
      request: 'Request',
      preparedRequest: 'Prepared context',
      systemInstructions: 'System instructions',
      preparedTools: ({ count }: { count: number }) => `Tool definitions (${count})`,
      preparedMessages: ({ count }: { count: number }) => `Messages (${count})`,
      sentRequest: 'Sent to provider',
      result: 'Result',
      modelResponse: 'Model response',
      localExecution: ({ count }: { count: number }) => `Local Execution (${count})`,
      noLocalExecution: 'No local execution was recorded for this request.',
      rawProviderRequest: 'Sent request JSON',
      rawProviderResponse: 'Normalized response JSON',
      requestDiagnostics: 'Request details',
      responseDiagnostics: 'Result details',
      ...
      inputTokenSummary: ({ count }: { count: string }) => `${count} estimated input tokens`,
