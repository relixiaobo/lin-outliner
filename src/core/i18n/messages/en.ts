...
export const en = {
  ...
  agent: {
    ...
    thread: {
      ...
      inputRemaining: ({ seconds }: { seconds: number }) => `Continues in ${seconds}s`,
      ...
      inputNavigation: 'Question navigation',
      ...
      inputReturnToQuestions: 'Back to questions',
      ...
      inputInMessage: 'Added to draft',
      inputShelfCount: ({ count }: { count: number }) => `Answer drafts (${count})`,
      ...
      inputCheckStatus: 'Check status',
      inputCopy: 'Copy answers',
      inputAddToMessage: 'Add to message draft',
      inputDiscard: 'Delete draft',
