...
commandPalette: {
  ...
  agent: {
    ...
    childRun: {
      ...
      detailTabsAriaLabel: 'Agent run detail tabs',
      actionsAriaLabel: 'Agent run actions',
      followUpAriaLabel: 'Agent run follow-up',
      followUpPlaceholder: 'Send a follow-up to this agent run',
