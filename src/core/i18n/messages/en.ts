...
export const en = {
  ...
  "fields": {
    ...
    general: {
      ...
      memoryResetTargetCounts: ({ containers, nodes, ordinary }: { containers: number; nodes: number; ordinary: number }) => `Memory sections: ${containers}. Notes to delete: ${nodes}, including ${ordinary} ordinary notes.`,
