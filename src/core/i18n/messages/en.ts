...
export const en = {
  ...
  agent: {
    ...
    trajectory: {
      ...
      rangeScope: 'Showing records in the selected Trajectory range.',
      ...
      followLive: 'Follow live Trajectory',
      ...
      exportThread: 'Export Thread Trajectory',
      exportWritten: ({ fileName, byteLength }: { fileName: string; byteLength: string }) =>
