...
export const en = {
  ...
  settings: {
    ...
    permissions: {
      ...
      trustLevelLabel: 'Default',
      trustLevelSublabel: 'Choose what routine agent work does when no exception applies.',
      ...
      hardBlockNote: "Some actions are always blocked and can't be changed here.",
      exceptionsGroup: (_: { mode: string }) => 'Exceptions',
      exceptionsAriaLabel: (_: { mode: string }) => 'Exceptions',
      noExceptions: 'No exceptions. Every action uses the default.',
      ...
      rawRuleDescription: 'Advanced JSON rule; it can match more than one action.',
      acceptedSkillsGroup: 'Accepted Skills',
      acceptedSkillsAriaLabel: 'Accepted skills',
      skillGrantSublabel: 'Accepted skill hash',
      revokeGrant: 'Revoke',
      commonActionsGroup: 'Actions',
      commonActionsAriaLabel: 'Actions',
