...
export const en = {
  ...
  shell: {
    ...
    filePreview: {
      ...
      metadataSize: 'Size',
      metadataPath: 'Path',
      pdfToolbar: 'PDF controls',
      pdfPreviousPage: 'Previous PDF page',
      pdfNextPage: 'Next PDF page',
      pdfPage: ({ page, total }: { page: number; total: number }) => `${page} / ${total}`,
      pdfZoomOut: 'Zoom out',
      pdfZoomIn: 'Zoom in',
      pdfZoom: ({ percent }: { percent: number }) => `${percent}%`,
