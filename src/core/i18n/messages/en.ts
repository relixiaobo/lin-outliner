...
export const en = {
  ...
  settings: {
    ...
    permissions: {
      ...
      trustLevelSublabel: 'Choose how much routine agent work can proceed before Lin asks.',
      askFirstMode: 'Ask First',
      balancedMode: 'Balanced',
      fullAccessMode: 'Full Access',
      grantedTrustGroup: 'Granted Trust',
      grantedTrustAriaLabel: 'Granted trust',
      noGrantedTrust: 'No grants yet.',
      actionGrantSublabel: 'Action grant',
      skillGrantSublabel: 'Accepted skill hash',
      revokeGrant: 'Revoke',
      commonActionsGroup: 'Advanced',
      commonActionsAriaLabel: 'Advanced',
