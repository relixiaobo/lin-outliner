...
export const zhHans: PartialMessages = {
  ...
  settings: {
    ...
    permissions: {
      ...
      trustLevelSublabel: '选择 Lin 在执行常规智能体工作前需要询问的频率。',
      askFirstMode: '先询问',
      balancedMode: '平衡',
      fullAccessMode: '完全访问',
      grantedTrustGroup: '已授予的信任',
      grantedTrustAriaLabel: '已授予的信任',
      noGrantedTrust: '还没有授权。',
      actionGrantSublabel: '操作授权',
      skillGrantSublabel: '已接受的技能哈希',
      revokeGrant: '撤销',
      commonActionsGroup: '高级',
      commonActionsAriaLabel: '高级',
