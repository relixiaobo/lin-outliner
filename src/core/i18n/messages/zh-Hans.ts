...
export const zhHans: PartialMessages = {
  ...
  settings: {
    ...
    memory: {
      ...
      dreamRunNowSublabel: '手动把近期聊天整理到今天的记忆节点中。定时 Dream 仍然每天最多运行一次。',
      dreamRunNowButton: '运行',
      dreamRunNowBusy: 'Dream 中…',
      dreamRunNotice: 'Dream 已完成',
      dreamThinTitle: '自上次 Dream 后新增对话不多',
      dreamThinDetail: ({ messages, chars }: { messages: number; chars: number }) =>
        `自上次 Dream 以来只有约 ${messages} 条新消息(~${chars} 字)。现在运行主要是整理既有记忆,而非记录新对话。`,
...
commandPalette: {
  ...
  agentDebug: {
    ...
    statCost: '成本',
    summaryTitle: '总结',
    summaryAriaLabel: '运行详情总结',
    detailsTitle: '详情',
    detailsAriaLabel: '运行详情内容',
    turnsTitle: '轮次',
    filterAll: '全部',
    kindTurn: 'turn',
    ...
    runListAriaLabel: '运行列表',
    selectedRunAriaLabel: '选中运行详情',
    contextTitle: '上下文',
    processTitle: '过程',
    usageTitle: '用量',
    advancedTitle: '高级',
    ...
    actualCost: '实际成本',
    cacheHitRate: '缓存命中',
    cachedContextShare: '缓存占比',
    cacheChartLabel: '输入上下文缓存构成',
    uncachedInput: '未缓存输入',
    cacheRead: '缓存读取',
    cacheWrite: '缓存写入',
    noCacheActivity: '此运行没有缓存活动。',
    costInput: '输入成本',
    costOutput: '输出成本',
