...
commandPalette: {
  ...
  agentDebug: {
    ...
    loadingRuntime: '正在加载执行树…',
    loadingRun: '正在加载运行详情…',
    timelineAriaLabel: 'Agent 执行树',
    overviewAriaLabel: 'Agent 调试概览',
    filterAriaLabel: '按 agent 过滤',
    noRuntimeData: '尚未捕获任何运行。',
    noRoundsYet: '尚未捕获任何轮次。',
    unknown: '未知',
    empty: '（空）',
    metricShape: '形态',
    shapeDm: '私聊',
    shapeChannel: '频道',
    membersCount: ({ count }) => `${count} 个 agent`,
    statTotalRuns: '运行',
    statRoundsMeta: ({ count }) => `${count} 轮`,
    statTokens: 'Tokens',
    statCost: '成本',
    filterAll: '全部',
    kindTurn: 'turn',
    ...
    delegatedBadge: '委派',
    runRounds: ({ count }) => `${count} 轮`,
    systemPromptDisclosure: '系统提示词',
    toolsDisclosure: ({ count }) => `工具 · ${count}`,
    noTools: '此运行未捕获工具。',
    noDescription: '无描述',
    roundTitle: ({ index }) => `第 ${index} 轮`,
    usagePending: '用量待定',
    usageTokens: ({ total, input, output }) => `${total} tokens（输入 ${input} / 输出 ${output}）`,
