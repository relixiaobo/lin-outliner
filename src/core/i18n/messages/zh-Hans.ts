...
export const zhHans: PartialMessages = {
  ...
  settings: {
    ...
    permissions: {
      ...
      trustLevelLabel: '默认',
      trustLevelSublabel: '选择没有例外时，常规智能体工作如何处理。',
      askFirstMode: '先询问',
      balancedMode: '平衡',
      fullAccessMode: '完全访问',
      customModeLabel: '自定义',
      ...
      hardBlockNote: '有些操作始终会被阻断，不能在这里更改。',
      exceptionsGroup: () => '例外',
      exceptionsAriaLabel: () => '例外',
      noExceptions: '没有例外。所有操作都使用默认设置。',
      modifiedChip: '已修改',
      advancedRuleChip: '高级',
      revertException: '还原',
      addExceptionSummary: '添加例外',
      rawActionDescription: ({ action }) => `${action} 的操作规则。`,
      rawRuleDescription: '高级 JSON 规则，可能匹配多个操作。',
      acceptedSkillsGroup: '已接受的技能',
      acceptedSkillsAriaLabel: '已接受的技能',
      skillGrantSublabel: '已接受的技能哈希',
      revokeGrant: '撤销',
      commonActionsGroup: '操作',
      commonActionsAriaLabel: '操作',
    ...
    agents: {
      ...
      builtInReadOnly: '内置智能体仅可查看。复制后可创建可编辑的副本。',
  ...
  shell: {
    ...
    filePreview: {
      ...
      metadataPath: '路径',
      pdfToolbar: 'PDF 控制',
      pdfPreviousPage: '上一页 PDF',
      pdfNextPage: '下一页 PDF',
      pdfPage: ({ page, total }) => `${page} / ${total}`,
      pdfZoomOut: '缩小',
      pdfZoomIn: '放大',
      pdfZoom: ({ percent }) => `${percent}%`,
