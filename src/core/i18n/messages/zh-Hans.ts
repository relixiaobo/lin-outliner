  ...
  agent: {
    ...
    toolCall: {
      ...
      verbs: {
        ...
        stopTask: { base: '停止任务', pending: '正在停止任务', done: '已停止任务' },
        ...
        checkHistory: { base: '检查操作历史', pending: '正在检查操作历史', done: '已检查操作历史' },
    ...
    childRun: {
      ...
      detailsAriaLabel: '智能体运行详情',
      closeDetails: '关闭运行详情',
      close: '关闭',
      metaLine: ({ count, duration }) => `${count} 条消息 · ${duration}`,
      sectionResult: '结果',
      sectionChildRuns: ({ count }) => `子运行（${count}）`,
      sectionVerification: '验证',
      sectionActivityLog: ({ count }) => `活动记录（${count}）`,
      sectionTechnicalDetails: '技术详情',
      stop: '停止',
      stopping: '正在停止……',
      metaAgentId: '智能体 ID',
      metaType: '类型',
