...
const FIXED_CAPABILITIES = [
  capability({ name: 'version', kind: 'local', runtimeRequired: false, streaming: false, destructive: false, auditCategory: 'metadata', summary: 'Print CLI, app, and protocol versions.', requestSchema: EmptyInput, resultSchema: Type.Object({ cliVersion: Type.String(), protocolMajors: Type.Array(Type.Integer()) }, closed), coverage: [] }),
  ...
  capability({ name: 'watch', kind: 'observe', runtimeRequired: true, streaming: true, destructive: false, auditCategory: 'observe', summary: 'Stream ordered resumable Runtime events.', requestSchema: Type.Object({ cursor: Type.Optional(Type.String()), projection: Type.Optional(ProjectionSchema) }, closed), resultSchema: EventSchema, coverage: ['document_events'] }),
