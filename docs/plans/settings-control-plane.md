...
| D. [Skill lifecycle operations](skill-lifecycle-operations.md) | Shared human/Agent install/update/reversal/provenance operations, with file-only availability and no managed enable writer | A, Skill identity foundation, and domain-owned declarative Skill settings; Skill owners; FR-2 through FR-6 |
