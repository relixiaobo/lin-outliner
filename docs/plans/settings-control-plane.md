...
| E1. [Memory operations](memory-operations.md) | Shared human/Agent status, Open Memory, confirmed Reset, and per-Thread mode; global enablement remains a file edit | A; Memory, Thread details, and root tool owners; FR-5, FR-6 |
