...
| [`agent-browser-computer-tools.md`](agent-browser-computer-tools.md) | draft | P1 | Browser and macOS desktop-control tool contract, with core implementation semantics from browser-pilot/computer-pilot and secondary tool-surface lessons from lin-agent/sider-agent. |
