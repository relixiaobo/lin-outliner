...
| Tana import (nodex `services/tana-import.ts`) | Not a nodex-parity port. The chosen direction is Tenon's `tenon-import` cleanup and import Skill, with Tana as the first deterministic route; see [`agent-import-skill.md`](../archive/agent-import-skill.md). |
