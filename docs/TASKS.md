...
**parent-verifies-child** rule, still `draft`, see Agent capabilities). **No PR open.** The agent subsystem portfolio is otherwise mature (single-agent collapse + one-Neva
