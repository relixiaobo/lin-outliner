...
| Agent settings | `AgentSettingsView.tsx`, `SettingsGeneralSection.tsx`, `SettingsAgentSection.tsx`, `SettingsPreviewSection.tsx`, `SettingsAboutSection.tsx`, `SettingsProvidersSection.tsx`, `SettingsSecuritySection.tsx`, `SettingsSkillLibrarySection.tsx`, `ManagedSkillsSettings.tsx`, `MemorySettingsGroup.tsx`, `DataMaintenanceRow.tsx`, `SettingsInsetList.tsx`, `SettingsRowMenu.tsx`, `ProviderConfigWindow.tsx` / `ProviderConfigForm.tsx` / `ProviderOAuthForm.tsx`, `providerStatus.ts`, `settingsProviderModel.ts`, `providerCatalog.tsx`, `styles/settings-*.css` | [Surfaces → Settings Window](./design-system/surfaces.md#settings-window) owns the standalone settings window, inset grouped content, row menu, and provider windows. |
