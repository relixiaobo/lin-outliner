...
## Desktop Domain Composition

Electron main composes two typed backend domain hosts before application
orchestration begins. `createOutlineDesktopHost` owns the Runtime supervisor and
