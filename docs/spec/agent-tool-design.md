...
scheduled volume bar); below the bar it advises "likely nothing new to
consolidate" and offers a "Dream anyway" override instead of running. A run computes per-stream seq ranges from
